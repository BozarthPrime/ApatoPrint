...
exports.printerStatus = function(callback) {
    rest.get("/api/printer?history=true&limit=2", headers, function(data, error) {
        if (error != null) {
...
exports.jobStatus = function(callback) {
    rest.get("/api/job", headers, function(data, error) {
        if (error != null) {
...
exports.pause = function(callback) {
    rest.post("/api/job", '{"command": "pause", "action": "pause"}', headers, function(data, error) {
        if (error != null) {
...
exports.resume = function(callback) {
    rest.post("/api/job", '{"command": "pause", "action": "resume"}', headers, function(data, error) {
        if (error != null) {
...
exports.cancel = function(callback) {
    rest.post("/api/job", '{"command": "cancel"}', headers, function(data, error) {
        if (error != null) {
...
exports.print = function(location, callback) {
    ...
    rest.post("/api/files" + location, '{"command": "select", "print": true}', headers, function(data, error) {
        if (error != null) {
            console.log("There was an error calling cancel: " + JSON.stringify(error));
            callback(false);
        } else {
...
exports.getAllFiles = function(callback) {
    rest.get("/api/files", headers, function(data, error) {
        if (error != null) {
...
exports.uploadFile = function(file, callback) {
    rest.post("/api/files", file, headers, function(data, error) {
        if (error != null) {
            console.log("There was an error calling cancel: " + JSON.stringify(error));
            callback(false);
        } else {
...
exports.connect = function(callback) {
    rest.post("/api/connection", '{"command": "connect"}', headers, function(data, error) {
        if (error != null) {
...
exports.disconnect = function(callback) {
    rest.post2("/api/connection", '{"command": "disconnect"}', headers, function(data, error) {
        if (error != null) {
